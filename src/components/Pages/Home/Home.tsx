...
const Home: React.FC<HomeProps> = ({ isMobile }) => {
  ...
  const featuredServices = [
    {
      ...
      description:
        'Безопасное и анонимное подключение с гарантией конфиденциальности. Поддержка всех устройств.',
    ...
    },
    {
      ...
      title: 'VPS',
      description:
        'Виртуальные серверы с мощным железом и низкой задержкой. Полный root доступ.',
  ...
  useEffect(() => {
    ...
    // Анимация для контента CTA секции
    ...
    // Обновляем ScrollTrigger после регистрации всех анимаций
