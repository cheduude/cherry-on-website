export const VALIDATION_RULES = {
  ...
  // Обновленная регулярка: минимум 8 символов, заглавная, строчная, цифра, специальный символ
...
export const VALIDATION_MESSAGES = {
  ...
  PASSWORD_WEAK: 'Пароль должен содержать хотя бы одну заглавную букву, одну строчную букву, одну цифру и один специальный символ (@$!%*?&)',
